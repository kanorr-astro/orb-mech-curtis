...
%{
This function uses a selected Runge-Kutta procedure to integrate a system
...
n_stages        -the number of points within a time interval that the
                derivatives are to be computed
a               -coefficients for locating the solution points within each time
                interval
b               -coefficients for computing the solution at the end of the time
                step
c               -coefficients for the computing solution at the end of the time
                step
ode_function    -handle for the user M-function in which the derivatives f
                are computed
...
switch rk
    ...
    case 4
        ...
        c = [1/6 1/3 1/3 1/6];
    otherwise
        error('The parameter rk must have the value 1, 2, 3, 4.')
end
