...
t0                  -initial time (s)
tf                  -final time (s)
R1_0, V1_0          -3 by 1 column vectors containing the components of the
...
t                   -column vector of the times at which the solution is
                    found
X1, Y1, Z1          -column vectors containing the X, Y, Z coordinates (km)
                    of m1 at the times in t
X2, Y2, Z2          -column vectors containing the X, Y, Z coordinates (km)
                    of m2 at the times in t
VX1, VY1, VZ1       -column vectors containing the Vx, Vy, Vz coordinates
                    (km/s) of m1 at the times in t
VX2, VY2, VZ2       -column vectors containing the Vx, Vy, Vz coordinates
                    (km/s) of m2 at the times in t
y                   -a matrix whose 12 columns are, respectively, 
                    X1, Y1, Z1; X2, Y2, Z2; Vx1, Vy1, Vz1; Vx2, Vy2, Vz2
XG, YG, ZG          -column vectors containing the X, Y, Z coordinates (km)
                    of the center of mass at the times in t
...
t                   -time (s)
y                   -column vector containing the position and velocity
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%{
This function calculates the trajectory of the center of mass and plots
...
User subfunctions required: common_axis_settings
%}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%{
This function establishes axis properties common to several plots.
%}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
text(0, 0, 0, 'o')
axis('equal')
