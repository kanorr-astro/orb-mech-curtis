...
It also plots the orbit and computes the times at which the maximum and
minimum radii occur and the speeds at those times.
...
t                       -column vector of the times at which the solution
                        is found
y                       -a matrix whose columns are:
                            columns 1,2,3:
                                The solution for the x,y,z components of
                                the position vector r at the times in t
                            columns 4,5,6:
                                The solution for the x,y,z components of
                                the velocity vector v at the times in t
r                       -magnitude of the position vector at the times in t
imax                    -component of r with the largest value
rmax                    -largest value of r
imin                    -compnenet of r with the smallest value
...
t                       -time (s)
f                       -column vector containting the position vector and
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%{
This function computes the maximum and minimum radii, the times they occur
and the speed at those times. It prints those results to the command window
and plots the orbit.

r                       -magnitude of the position vector at the times in t
imax                    -components of r with the largest value
rmax                    -largest value of r
imin                    -components of r with the smallest value
rmin                    -smallest value of r
v_at_rmax               -speed where r = rmax
v_at_rmin               -speed where r = rmin

User sub-function required: light_gray
%}
%-------------------------------
for i = 1:length(t)
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%{
This function creates a color map for displaying the planet as light gray
with a black equator.
